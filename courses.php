...
<a href="homepage.php" style="position: absolute; top: 0px; left: 20px; text-decoration: none; color: black;">
    ...
    <h2>Courses</h2>
    <a class="b" href="add_course.php">Add New Course</a>
    <table border="1">
        <tr>
            <th>ID</th>
            <th>Course Name</th>
        ...
        <tr>
            ...
            <td>
                <a href="edit_course.php?id=<?= $row['id'] ?>"class="edit-link">Edit</a>
                <a href="delete_course.php?id=<?= $row['id'] ?>" class="delete-link" onclick="return confirm('Are you sure?')">Delete</a>
            </td>
        </tr>
        <?php endwhile; ?>
    </table>
